...
class Table(Element):
    ...
    def create_simple_header_row(
        self, *headers: Union[str, bytes, Generator]
    ) -> TableRow: ...
    def create_simple_row(
        self, *cells: Union[str, bytes, Generator]
    ) -> TableRow: ...
    def generate_header_rows(
        self
    ) -> typing.Generator[TableRow, None, None]: ...
...
class TableRow(Element):
    def __init__(self) -> None: ...
    def create_cell(
        self, content: Union[str, bytes, Generator] = ...
    ) -> TableCell: ...
    def create_cells(
        self, *content: Union[str, bytes, Generator]
    ) -> List[TableCell]: ...
...
class ColumnGroup(Element):
    ...
    def create_columns_with_classes(
        self, *css_classes: str
    ) -> List[Column]: ...
